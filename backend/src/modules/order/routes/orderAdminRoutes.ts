...
import { adminOrdersQuerySchema, objectIdParamSchema } from "#src/modules/order/validators/orderValidators";
...
router
  .route("/:id")
  .get(validate(objectIdParamSchema, "params"), OrderAdminController.getOrderById);
